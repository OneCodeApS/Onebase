...
-- tool. Mirror of postgres/migrations/0022_access_tokens.sql for fresh installs.
...
CREATE TABLE _dashboard.access_tokens (
...
CREATE INDEX access_tokens_user_id_idx
...
CREATE TABLE _dashboard.migrations (
